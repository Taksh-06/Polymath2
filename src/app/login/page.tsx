        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-card/50 backdrop-blur-xl border border-border/50 p-8 rounded-3xl shadow-2xl">
            ...
            <button
              ...
              className="w-full bg-background hover:bg-muted border border-border text-foreground font-medium py-3 rounded-2xl transition-all flex items-center justify-center gap-2 group"
            >
